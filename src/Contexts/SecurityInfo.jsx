...
const SecurityInfo = ({handleNext}) => {
  ...
  const handleSecurityAnswerChange = (e) => {
    ...
    const handleNextClick = () => {
      ...
      if (!isPasswordValid) {
        toast.error('Password must include at least 8 characters, including capital letters, small letters, numbers, and special characters.');
        return;
      }
  ...
  return (
    ...
    <div className="hover:animate-bounce  absolute left-[-90%] ">
    <a href="/">
    ...
    <h4 className="font-semi-bold text-black  text-[24px] flex  sm:pl-[0] xs:pl-[2rem] justify-center leading-[29px]">Security Information</h4>
    ...
    <div className="flex flex-col mt-5 ">
      <form className="xs:justify-center flex flex-col xs:items-center gap-5  ">
        <div  className="flex flex-col gap-2 xs:pl-[4rem] lg:pl-[0]  sm:pl-[8rem]">
          <label className="font-400 text-[18px] text-primary  leading-[22px] font-Inter ">Username:</label>
          <input
            type="text"
            value={username}
            ...
            className="xxl:w-[787px] sm:w-[587px] xs:w-[309px] h-[63px] rounded-[8px] outline-primary border-2 border-primary pl-2 "
          />
        </div>

        <div className=" flex sm:flex-row xs:flex-col gap-5 ">
        <div className="flex flex-col gap-2 xs:pl-[4rem] lg:pl-[0]  sm:pl-[8rem]  ">
          <label  className="font-400 text-[18px] text-primary  leading-[22px] font-Inter ">Create Password:</label>
          <div className={`relative ${isPasswordValid ? '' : 'invalid-password'}`}>
              <input
            ...
            className={`xxl:w-[309px] sm:w-[309px] xs:w-[309px] outline-primary h-[63px] rounded-[8px] border ${
              isConfirmPasswordTouched && !isPasswordValid ? 'border-red-500' : 'border-primary'
            } pl-2 `}/>
           <span
        ...
        <div className="flex flex-col gap-2 xs:pl-[4rem] relative ">
          <label className="font-400 text-[18px] text-primary leading-[22px] font-Inter ">Re-type Password:</label>
          <input
        ...
        <div className=" flex sm:flex-row xs:flex-col gap-5  ">
        <div className="flex flex-col gap-2 xs:pl-[4rem] lg:pl-[0]  sm:pl-[8rem]">
          <label className="font-400 text-[18px] leading-[22px] text-primary font-Inter ">Security Question:</label>
          <select
          ...
          >
            ...
            <option value="What is your pet's name?">What is your pets name?</option>
        ...
        <div className="flex flex-col gap-2 xs:pl-[4rem]">
          <label className="font-400 text-[18px] leading-[22px] text-primary font-Inter ">Answer Security Question:</label>
          <input
            type="text"
